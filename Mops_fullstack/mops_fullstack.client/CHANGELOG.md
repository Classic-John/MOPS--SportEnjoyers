...
- Create Angular project with ng: `ng new mops_fullstack.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mops_fullstack.client.esproj`).
